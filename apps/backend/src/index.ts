...
import { createAdminOpsRouter, type AdminOpsBroadcastKind } from "./routes/adminOps.js";
...
app.use(
  createAdminOpsRouter({
    ...
    auditLogService,
    emitRoomUpdate,
    broadcastOpsUpdate: (kind: AdminOpsBroadcastKind, payload?: Record<string, unknown>) => {
