...
$(document).ready(function() {
    console.log("subGameColorRow", subGameColorRow, subGameColorRow.length);
    let subGames = [{}];
    if (subGameColorRow.length) {
        subGames = JSON.parse(subGameColorRow.replace(/&quot;/g, '"'));
    }
                    ...
                    if (checkColorsIsIn.length > 0) {
                        ...
                        <div class="row" style="width:100%;">
                                ...
                                <div class="col-lg-9 pd-l-5">
                                    <ul class="${value.gameType}_price_ul " style="display:block !important;"> 
            ...
            <div class="full-width-box tket-color-type mb-10 ${colorDivId}_color_div" style="display: none">
                <div class="row">
                    ...
                    <div class="col-lg-10 pd-l-5">
                        <ul class="${colorDivId}_color_ul" style="display:block !important;">   
                        </ul>
                    </div>
                </div>
            </div>  
    ...
    $(document).on("change", ".dropdown_box input[type='checkbox']", function() {
        ...
        console.log("checked _______________________AAAAA", className);
        ...
        // Add 8 colors of single input
            ...
            console.log("+++++++++++++++ +++++++++++ : "+ecflag+" gametype gametype : "+gametype)
            if(!ecflag){
                $('.' + gametype + '_price_ul').find('li').parent().remove();
                $('#'+gametype+'_price_div').addClass('hide');

            }else{
                console.log(" subGames subGames subGames : ====================== : ",subGames)
                if($('.' + gametype + '_price_ul li').length=='0'){
                    for (let i = 0; i < subGames[gametype].rows.length; i++) {
                        
                        console.log(" subGames[gametype].rows[i] subGames[gametype].rows[i] : ",subGames[gametype].rows[i]+" isGameTypeExtra : ", subGames[gametype].rows[i].isGameTypeExtra)
                            let read="";
                            let value="";
                            if((subGames[gametype].rows[i].isGameTypeExtra)){
                                read="readonly";
                                value=0;  
                            }    
                                let options = `<div class="col-md-4"><li> <div class="row">
                                                    <div class="col-lg-6 pd-r-5">
                                                        <label data-toggle="tooltip" title="${gametype} ${subGames[gametype].rows[i].name}"> ${subGames[gametype].rows[i].name} </label>
                                                    </div>
                                                    <div class="col-lg-6 pd-l-5">
                                                        <input gs="11" type="text" value="${value}" name="${gametype}${subGames[gametype].rows[i].type}" class="form-control" placeholder="10" ${read} required>
                                                    </div></div>
                                                </li> </div>`;
            ...
            /*<input type="hidden" name="${gametype}_eightColorInput[]" value="${subGames[gametype].rows[i].name}">
                                                        <input type="text" name="${gametype}_eightColorValue[]" class="form-control" placeholder="10">*/

        console.log("++++++++++++++++++++++++++++AAAAAAAAAAAAAAAA : "+ecflag)
        ...
        $.each(idName, function(key, val) {
            ...
            console.log(" idName idName idName : ",val)
            ...
            if (!$("#" + val.name.replace(/\s/g, '')).length) {
                ...
                let html = `<div class="col-lg-4"> 
                                <li id= "${val.name.replace(/\s/g, '')}"> <div class="row">
                                    <div class="col-lg-6">
                                            <label data-toggle="tooltip" class="form-control" title="` + (val.value) + `">` + (val.value) + `</label>
                                        </div>
                                        <div class="col-lg-6 ">
            ...
            $.each(resultsKeyword, function(key, value) {
                ...
                let htmlPrice = ` <div id="${value.name}_price_div" class="full-width-box tket-color-type mb-10 ${value.name}_price_div" >
                                    <div class="row" style="width:100%">
                                        ...
                                        <div class="col-lg-9 pd-l-5" >
                                            <ul class="${value.name}_price_ul" style="display:block !important"> 
                ...
                for (let i = 0; i < subGames[newGameType].rows.length; i++) {
                    console.log(" subGames[newGameType].rows : ",subGames[newGameType].rows)
                    let read="";
                    let val = "";
                    ...
                    let options = `<div class="col-md-4"> <li> <div class="row">
                                                ...
                                                <div class="col-lg-6 pd-l-5">
                                                <input ch="1212" type="text" value="${val}" name="${value.name}${subGames[newGameType].rows[i].type}" class="form-control" placeholder="10" required  ${read} />
                                                </div></div>
                                            </li> </div> `
                            ...
                            for (let i = 0; i < subGames[newGameType].rows.length; i++) {
                                ...
                                let options = ` <li> 
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 pd-l-5">
                                                            <input ch="2222" type="text" value="${val}" name="${newGameType}_${ulClassColorCombiniation}_${nameColor1}_${subGames[newGameType].rows[i].type}" class="form-control" placeholder="10" ${read} required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 pd-l-5">
                                                            <input ch="3333 type="text"  value="${val}" name="${newGameType}_${ulClassColorCombiniation}_${nameColor2}_${subGames[newGameType].rows[i].type}" class="form-control" placeholder="10" ${read} required />
                                                        </div>
                                                    </div>
                                ...
                                for (let i = 0; i < subGames[newGameType].rows.length; i++) {
                                    ...
                                    let options = ` <li> 
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 pd-l-5">
                                                                <input ch="4444" type="text" value="${val}" name="${newGameType}_${same3Color[o].type}_${nameColor1}_${subGames[newGameType].rows[i].type}" class="form-control" ${read} placeholder="10" required />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 pd-l-5">
                                                                <input ch="5555" type="text" value="${val}" name="${newGameType}_${same3Color[o].type}_${nameColor2}_${subGames[newGameType].rows[i].type}" class="form-control" ${read} placeholder="10" required />
                                                            </div>
                                                        </div>
