...
public class GameSocketManager : MonoBehaviour
{
    ...
    {
        // Phase 3: Skip AIS socket connection — Spillorama backend handles all game communication.
        // In WebGL host mode SpilloramaSocketManager is used; in Editor the ShellSimulator path applies.
#if UNITY_EDITOR
        Debug.Log("[GameSocketManager] Skipping AIS connection in Editor — using Spillorama path");
        return;
#endif
        if (SpilloramaSocketManager.IsConnected || UIManager.Instance?.isGameWebGL == true)
        {
            Debug.Log("[GameSocketManager] Skipping AIS connection — Spillorama path active");
            return;
        }
    ...
    public static string SetSocketGame1Namespace
    {
        set
        {
            if (socketManager == null) { Debug.Log("[GameSocketManager] socketManager null — skipping Game1 namespace"); return; }
    ...
    public static string SetSocketGame2Namespace
    {
        set
        {
            if (socketManager == null) { Debug.Log("[GameSocketManager] socketManager null — skipping Game2 namespace"); return; }
    ...
    public static string SetSocketGame3Namespace
    {
        set
        {
            if (socketManager == null) { Debug.Log("[GameSocketManager] socketManager null — skipping Game3 namespace"); return; }
    ...
    public static string SetSocketGame4Namespace
    {
        set
        {
            if (socketManager == null) { Debug.Log("[GameSocketManager] socketManager null — skipping Game4 namespace"); return; }
    ...
    public static string SetSocketGame5Namespace
    {
        set
        {
            if (socketManager == null) { Debug.Log("[GameSocketManager] socketManager null — skipping Game5 namespace"); return; }
