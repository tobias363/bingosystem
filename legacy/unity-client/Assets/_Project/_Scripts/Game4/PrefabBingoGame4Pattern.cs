...
public class PrefabBingoGame4Pattern : MonoBehaviour
{
    ...
    [SerializeField]private Sprite _1L_Sprite;
    [SerializeField] private Sprite _2L_Sprite;
    ...
    public void SetData(Game4PatternData patternData)
    {
        ...
        if(patternData.extra == "1L")
        {
            ...
            L_Object.GetComponent<Image>().sprite = _1L_Sprite;
        }
        else if (patternData.extra == "2L")
        {
            L_Object.SetActive(true);
            L_Object.GetComponent<Image>().sprite = _2L_Sprite;
        }
        else
        {
