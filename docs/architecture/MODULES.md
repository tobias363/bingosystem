...
**Color-key:**
- 🔴 Red = legacy / refactor-candidate (BingoEngine — 5330 LOC, HV-3 candidate)
...
|---|---:|---|---|
| `BingoEngine` | 5330 | Multi-game ad-hoc engine (Spill 2/3 + test-hall Spill 1 post-K3) | [📄](./modules/backend/BingoEngine.md) |
...
| `PhasePayoutService` | 318 | Cap-and-transfer flow (extracted F2-A — used by `BingoEngine`) | [📄](./modules/backend/PhasePayoutService.md) |
...
| `apps/backend/src/game/BingoEngine.ts` | 5330 | ✅ |
