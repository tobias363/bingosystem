...
**Color-key:**
- 🔴 Red = legacy / refactor-candidate (BingoEngine — 5136 LOC, HV-3 candidate)
...
|---|---:|---|---|
| `BingoEngine` | 5136 | Multi-game ad-hoc engine (Spill 2/3 + test-hall Spill 1 post-K3) | [📄](./modules/backend/BingoEngine.md) |
...
| `apps/backend/src/game/BingoEngine.ts` | 5436 | ✅ |
