...
public class EventManager : MonoBehaviour
{
    ...
    public static Action<int, int, bool, int> OnMissingPattern;
    ...
    public static void ShowMissingPattern(int patternIndex, int colIndex, bool active, int missingNumber = 0)
    {
        OnMissingPattern?.Invoke(patternIndex, colIndex, active, missingNumber);
    }
