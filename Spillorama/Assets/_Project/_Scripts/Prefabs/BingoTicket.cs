...
public class BingoTicket : MonoBehaviour
{
    ...
    IEnumerator HideTicketDetailsAnimation()
    {
        ...
        {
            if (UIManager.Instance.game1Panel.game1GamePlayPanel.isTimerReceived || UIManager.Instance.game2Panel.game2PlayPanel.isTimerReceived || UIManager.Instance.game3Panel.game3GamePlayPanel.isTimerReceived)
            {
