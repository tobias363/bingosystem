...
public class PrefabBingoGame3Pattern : MonoBehaviour
{
    ...
    [Header("Prize")]
    public double Pattern_Prize;
    public TMP_Text Prize_Txt;
    ...
    public void SetData(PatternData patternData, int Rowindex)
    {
        ...
        Ball_Number = patternData.ballNumber;
        Pattern_Name = patternData.name;
        Pattern_ID = patternData._id;
        Pattern_Design = patternData.patternDesign;
        Pattern_Prize = patternData.amount;
        Prize_Txt.text = $"{Pattern_Prize} kr";
