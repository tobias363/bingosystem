...
public class DatePickerInputBox : MonoBehaviour
{
    #region PUBLIC_VARIABLES
    public static OnValueChangeEnd OnValueEditEnd;
    ...
    public void SetTodayDate()
    {
        ...
        SetDate(today.Day.ToString(), today.Month.ToString(), today.Year.ToString());
    }
    ...
    public void RefreshDayField()
    {
        ...
        if (UIManager.Instance.lobbyPanel.walletPanel.myWinningsPanel.gameObject.activeSelf)
        {
            if (day > 0 && month > 0 && year > 0)
            {
                UIManager.Instance.lobbyPanel.walletPanel.myWinningsPanel.OnDateValueChanged();
            }
        }
    }
    ...
    public void SetDate(string day, string month, string year)
    {
        ...
        UIManager.Instance.lobbyPanel.walletPanel.myWinningsPanel.date = $"{year}-{month}-{day}";
    }
    #endregion
...
public delegate void OnValueChangeEnd();