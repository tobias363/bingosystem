...
public partial class Game1GamePlayPanel : MonoBehaviour
{
    ...
    [SerializeField] private List<GameObject> Elvis_Tickets;
    ...
    [Header("Text")]
    [SerializeField]
    private TextMeshProUGUI txtLuckyNumber;
    ...
    [SerializeField] private RectTransform Chat_Panel_RT;
    ...
    private bool isGameRefreshed = false;
