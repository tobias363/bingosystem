...
/**
 * Row 2 = any 2 complete vertical columns — C(5,2) = 10 combinations.
 * Matches backend `colCount >= 2` in `BingoEngine.meetsPhaseRequirement`.
 */
export const ROW_2_MASKS: readonly PatternMask[] = Object.freeze([
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[1],
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[2],
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[3],
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[4],
  VERTICAL_COLUMN_MASKS[1] | VERTICAL_COLUMN_MASKS[2],
  VERTICAL_COLUMN_MASKS[1] | VERTICAL_COLUMN_MASKS[3],
  VERTICAL_COLUMN_MASKS[1] | VERTICAL_COLUMN_MASKS[4],
  VERTICAL_COLUMN_MASKS[2] | VERTICAL_COLUMN_MASKS[3],
  VERTICAL_COLUMN_MASKS[2] | VERTICAL_COLUMN_MASKS[4],
  VERTICAL_COLUMN_MASKS[3] | VERTICAL_COLUMN_MASKS[4],
]);

/**
 * Row 3 = any 3 complete vertical columns — C(5,3) = 10 combinations.
 * Matches backend `colCount >= 3` in `BingoEngine.meetsPhaseRequirement`.
 */
export const ROW_3_MASKS: readonly PatternMask[] = Object.freeze([
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[1] | VERTICAL_COLUMN_MASKS[2],
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[1] | VERTICAL_COLUMN_MASKS[3],
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[1] | VERTICAL_COLUMN_MASKS[4],
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[2] | VERTICAL_COLUMN_MASKS[3],
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[2] | VERTICAL_COLUMN_MASKS[4],
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[3] | VERTICAL_COLUMN_MASKS[4],
  VERTICAL_COLUMN_MASKS[1] | VERTICAL_COLUMN_MASKS[2] | VERTICAL_COLUMN_MASKS[3],
  VERTICAL_COLUMN_MASKS[1] | VERTICAL_COLUMN_MASKS[2] | VERTICAL_COLUMN_MASKS[4],
  VERTICAL_COLUMN_MASKS[1] | VERTICAL_COLUMN_MASKS[3] | VERTICAL_COLUMN_MASKS[4],
  VERTICAL_COLUMN_MASKS[2] | VERTICAL_COLUMN_MASKS[3] | VERTICAL_COLUMN_MASKS[4],
]);

/**
 * Row 4 = any 4 complete vertical columns — C(5,4) = 5 combinations.
 * Matches backend `colCount >= 4` in `BingoEngine.meetsPhaseRequirement`.
 */
export const ROW_4_MASKS: readonly PatternMask[] = Object.freeze([
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[1] | VERTICAL_COLUMN_MASKS[2] | VERTICAL_COLUMN_MASKS[3],
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[1] | VERTICAL_COLUMN_MASKS[2] | VERTICAL_COLUMN_MASKS[4],
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[1] | VERTICAL_COLUMN_MASKS[3] | VERTICAL_COLUMN_MASKS[4],
  VERTICAL_COLUMN_MASKS[0] | VERTICAL_COLUMN_MASKS[2] | VERTICAL_COLUMN_MASKS[3] | VERTICAL_COLUMN_MASKS[4],
  VERTICAL_COLUMN_MASKS[1] | VERTICAL_COLUMN_MASKS[2] | VERTICAL_COLUMN_MASKS[3] | VERTICAL_COLUMN_MASKS[4],
]);
